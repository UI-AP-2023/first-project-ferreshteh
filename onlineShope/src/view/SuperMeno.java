    ...
    public void adminMeno() {
        while (scanner != 5) {
            ...
            if (scanNer.equals("help")) {
                System.out.print("1-Responding to Registration requests  2-view comments 3-Product management(add\\delete\\edit) 4-viewProducts ");
                System.out.print(" 5-Responding to Requests for comments  6-Responding to Requests for credit enhancement 7-exit");
                scanner = sc.nextInt();
                if (scanner == 1) {
